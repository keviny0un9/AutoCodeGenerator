...
public class StringUtil {
	...
	public static String replaceDouHaoWithGan(String DaoHaoText){
...
//		}
		...
		String replace = DaoHaoText.replace(".", fileSeparator);
		log.info("return packageName with groupId: " + replace);
		return replace;
	}
...
//		}
		String replaceDouHaoWithGan = StringUtil
				.replaceDouHaoWithGan("com.kevin");
		System.out.println(replaceDouHaoWithGan);
	}
}
